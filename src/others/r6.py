...
<body>
    ...
    <script>
        ...
        // Handle input events in the contenteditable container
        ...
        function updatePages() {
            ...
            for (let i = 0; i < numPages; i++) {
                ...
                // Handle input within individual pages
        ...
        function handleSelectionChange(e) {
            ...
            if (selection.type === 'Range') {
                ...
                // Set a timer to handle the end of selection
        ...
        function pageInputHandler(e) {
            ...
            // Check if we need to move text to next/previous pages
            const page = e.target;
        ...
        // Container input handler function
        ...
        // Register container input handler
        container.addEventListener('input', containerInputHandler);
        ...
        // Handle special keys for navigation between pages
        document.addEventListener('keydown', (e) => {
            ...
            const activeElement = document.activeElement;
            if (!activeElement || !activeElement.classList.contains('page')) {
                return;
            }
