...
#########################
    def table_js(self):
        ...
        function insertTable(rows, cols, hasHeader, borderWidth, widthValue) {
            ...
            tableWrapper.style.width = widthValue === 'auto' ? 'auto' : widthValue;
            tableWrapper.style.margin = '10px 0';
            tableWrapper.style.overflowX = 'auto'; // For horizontal scrolling if needed
            ...
            if (borderWidth > 0) {
                table.style.border = `${borderWidth}px solid #ccc`;
            }
            ...
            if (hasHeader) {
                ...
                for (let i = 0; i < cols; i++) {
                    ...
                    if (borderWidth > 0) {
                        th.style.border = `${borderWidth}px solid #ccc`;
                    }
            ...
            for (let i = startRow; i < rows; i++) {
                ...
                for (let j = 0; j < cols; j++) {
                    ...
                    if (borderWidth > 0) {
                        cell.style.border = `${borderWidth}px solid #ccc`;
                    }
