...
class FlowBoxWindow(Adw.ApplicationWindow):
    def __init__(self, *args, **kwargs):
        ...
        # Set FlowBox properties to prevent items from stretching
    ...
    def add_word_to_flowbox(self, word):
        ...
        # Create a FlowBox child to maintain natural width
        flow_child = Gtk.FlowBoxChild()
        flow_child.set_child(box)
        flow_child.set_halign(Gtk.Align.START)  # Align the child to the start
