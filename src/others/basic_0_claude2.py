...
<body>
    ...
    <script>
        ...
        let lastActivePage = 0; // Track the last active page
        ...
        function checkOverflow() {
            ...
            if (lastContent.scrollHeight > lastContent.clientHeight) {
                ...
                // Set focus to the new page and place cursor at beginning
                setTimeout(() => {
                    const newPageIndex = pages.length - 1;
                    const newPageContent = pages[newPageIndex].querySelector('.page-content');
                    placeCursorAtEnd(newPageContent);
        ...
        function addNewPage() {
            ...
            newContent.addEventListener('focus', onFocus);
            ...
            return pageCount; // Return the index of the new page
        }
        ...
        function onFocus(event) {
            // Track the currently focused page
            const pageContent = document.querySelectorAll('.page-content');
            pageContent.forEach((content, index) => {
        ...
        function initializeEditor() {
            ...
            firstContent.addEventListener('focus', onFocus);
            firstContent.focus();
            
            // Add focus events to all existing pages
