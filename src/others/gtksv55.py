            ...
            <body>
                ...
                <script>
                    ...
                    function setTextWrap(image, wrap) {
                        // Store the text wrap setting in a data attribute
                        image.dataset.textWrap = wrap;
                        
                        // Remove any existing text-wrap-around class
                        image.classList.remove('text-wrap-around');
                        
                        if (wrap === 'none') {
                            image.style.float = image.classList.contains('align-center') ? 'none' : 'none';
                            image.style.shapeOutside = 'none';
                            ...
                            if (image.classList.contains('align-left')) {
                                ...
                                // Apply text wrapping for centered images
                                image.classList.add('text-wrap-around');
                                image.style.shapeOutside = 'content-box';
                                image.style.shapeMargin = '10px';
                            }
                        }
                    }
