...
"""
    ...
    def on_webview_load(self, webview, load_event):
        if load_event == WebKit.LoadEvent.FINISHED:
            ...
            # Register handler for textbox insertion command from UI
            self.webview.register_script_message_handler("insertTextBox")
            self.webview.connect("script-message-received::insertTextBox", self.on_insert_textbox)
