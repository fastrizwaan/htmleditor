...
class RichTextEditor(Adw.Application):
    ...
    def on_activate(self, app):
        ...
        # Create flowbox for toolbar items
        self.toolbar_flow = Gtk.FlowBox()
        self.toolbar_flow.set_valign(Gtk.Align.START)
        self.toolbar_flow.set_max_children_per_line(1)
        self.toolbar_flow.set_selection_mode(Gtk.SelectionMode.NONE)
        self.toolbar_flow.add_css_class("toolbar")
        self.main_box.append(self.toolbar_flow)

        # First Box Group (File Operations and Edit)
        self.file_operations_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=0)
        self.toolbar_flow.insert(self.file_operations_box, -1)

        # Second Box Group (Formatting)
        self.formatting_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=0)
        self.toolbar_flow.insert(self.formatting_box, -1)

        # Add buttons to first Box
        self.create_file_operations_buttons()
        
        # Add buttons to second Box
    ...
    def create_file_operations_buttons(self):
        ...
        for name, icon, callback in buttons_data:
            ...
            self.file_operations_box.append(button)
    ...
    def create_formatting_buttons(self):
        ...
        self.formatting_box.append(para_box)
        ...
        self.formatting_box.append(font_box)
        ...
        self.formatting_box.append(size_box)
        ...
        for name, icon, callback, tag in style_buttons_data:
            ...
            self.formatting_box.append(button)
