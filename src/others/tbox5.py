...
<head>
    ...
    <style>
        ...
        .text-box {
            ...
            cursor: text;
            overflow: hidden;
            /* Doubled invisible border for easier detection */
    ...
    <script>
        ...
        function createTextBox(x, y) {
            ...
            textBox.addEventListener('mousedown', (e) => {
                const rect = textBox.getBoundingClientRect();
                const borderWidth = 24; // Doubled for easier clicking
        ...
        function initEventListeners() {
            ...
            window.addEventListener('mousemove', (e) => {
                ...
                if (isDragging) {
                    ...
                    // FIXED: This section had a syntax error with "lastX" split across lines
                    const dx = e.clientX - lastX;
                    const dy = e.clientY - lastY;
