...
######################################################
    def setup_image_and_textbox_handling(self):
        ...
        (function() {
            ...
            function createMenuItems(parent, items) {
                items.forEach(item => {
                    if (item.type === 'separator') {
                        ...
                        if (item.action === 'inline' && !selectedElement.classList.contains('floating')) {
                            menuItem.style.fontWeight = 'bold';
                        }
            ...
            // Clear alignment classes
            function clearAlignmentClasses(element) {
                element.classList.remove('align-left', 'align was-right', 'align-center');
            }
