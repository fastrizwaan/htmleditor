...
#####################
    ...
    def create_window(self):
        ...
        win.toolbars_flowbox.set_selection_mode(Gtk.SelectionMode.NONE)
        win.toolbars_flowbox.set_max_children_per_line(100)
        win.toolbars_flowbox.set_column_spacing(0)  # Set column spacing to 0
        win.toolbars_flowbox.set_row_spacing(0)     # Set row spacing to 0
        win.toolbars_flowbox.set_homogeneous(False) # Allow different sized children
        win.toolbars_flowbox.set_halign(Gtk.Align.START) # Align items to start
        win.toolbars_flowbox.set_min_children_per_line(1)  # Allow wrapping after each child if needed

        #win.toolbars_flowbox.add_css_class("toolbar-container")
        win.toolbars_flowbox.set_margin_start(5)
        ...
        win.toolbars_flowbox.insert(text_style_group, -1)
        ...
        win.toolbars_flowbox.insert(text_format_group, -1)
        ...
        win.toolbars_flowbox.insert(list_group, -1)
        ...
        win.toolbars_flowbox.insert(align_group, -1)
