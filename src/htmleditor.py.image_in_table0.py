            ...
            setTimeout(() => {{
                ...
                if (newTable) {{
                    ...
                    if (cell) {{
                        ...
                        // Insert the image
                        const imgHtml = '<img src="data:{mime_type};base64,{encoded_image}" style="max-width:100%; display:block; width:100%;" data-embedded="true" alt="{filename}">';
                        
                        // If caption is enabled, add a figcaption-like structure
                        if ({str(add_caption).lower()}) {{
                            cell.innerHTML = '<div style="text-align:center;">' + imgHtml + 
                                              '<div style="font-size:0.9em; color:#555; margin-top:5px; text-align:center;">{filename}</div>' +
                                              '</div>';
                        }} else {{
