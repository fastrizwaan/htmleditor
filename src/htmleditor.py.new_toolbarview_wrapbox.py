...
class HTMLEditorApp(Adw.Application):
    ...
    def setup_css_provider(self):
        ...
        css_data = b"""
    .toolbar-container { padding: 0px 0px; background-color: rgba(127, 127, 127, 0.00); }
    ...
    .linked button:hover         {background-color: rgba(127, 127, 127, 0.25); border: solid 1px rgba(127, 127, 127, 0.30);}
    ...
    .linked button:checked:hover {background-color: rgba(127, 127, 127, 0.25); border: solid 1px rgba(127, 127, 127, 0.30);}
    ...
    .linked menubutton button:hover {
        ...
        border: solid 1px rgba(127, 127, 127, 0.40);
    }
    ...
    /* Search and replace styling - theme-aware */
    searchbar,
    searchbar.search-bar,
    searchbar.search-toolbar,
    searchbar.find-toolbar,
    .search-toolbar,
    .find-toolbar,
    .find-and-replace-container {
        background-color: transparent;
        border-top: 1px solid rgba(127, 127, 127, 0.20);
    }
    ...
    /* Style for search entry fields specifically */
    .search-entry entry, 
    entry.search-entry,
    searchentry,
    searchentry > * {
    ...
    /* Style for replace entry fields */
    .replace-entry entry,
    entry.replace-entry {
        background-color: white !important;
        color: black !important;
    ...
    /* For GTK4 search bars, adjust padding */
    searchbar box {
        padding: 4px;
    }

    /* Dark mode adjustments (only affects the app's UI, not the editor content) */
    ...
    window:dark {
        ...
        @define-color theme_selected_bg_color #264f78;
        @define-color theme_selected_fg_color #ffffff;
    }

    /* Even in dark mode, keep search/replace fields white */
    window:dark entry, 
    window:dark searchentry,
    window:dark searchentry text,
    window:dark searchentry textview,
    window:dark .search-entry entry, 
    window:dark entry.search-entry,
    window:dark .replace-entry entry,
    window:dark entry.replace-entry {
        background-color: white !important;
        color: black !important;
        caret-color: black;
    }
    ...
    <head>
        ...
        <style>
            ...
            @media (prefers-color-scheme: dark) {{
                ...
                /* Adjust text selection color for dark mode */
                #editor::selection {{
            ...
            @media (prefers-color-scheme: light) {{
                ...
                /* Adjust text selection color for light mode */
                #editor::selection {{
            ...
            /* Adjust border colors based on theme */
            @media (prefers-color-scheme: dark) {{
                #editor table, #editor th, #editor td {{
                    border-color: #444;
                }}
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {{
                // Function to detect if system is using dark mode
                function isDarkMode() {{
                    return window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches;
                }}
                
                // Apply theme-specific styles for dynamic content
                function applyThemeStyles() {{
                    ...
                    // You can use this function to apply any JS-dependent theme styling
...
##########################       
    def create_window(self):
        ...
        # Create toolbar view as the main container
        win.toolbar_view = Adw.ToolbarView()
        win.toolbar_view.add_css_class("toolbar-container")
        # Create the header bar
        win.headerbar = Adw.HeaderBar()
       # win.headerbar.add_css_class("toolbar-container")
        self.setup_headerbar_content(win)
        
        # Set the header bar as the top bar of the toolbar view
        win.toolbar_view.add_top_bar(win.headerbar)
        
        # Create toolbar revealer for smooth show/hide
        win.toolbar_revealer = Gtk.Revealer()
        #win.toolbar_revealer.add_css_class("toolbar-container")
        win.toolbar_revealer.set_transition_type(Gtk.RevealerTransitionType.SLIDE_DOWN)
        win.toolbar_revealer.set_transition_duration(250)
        win.toolbar_revealer.set_reveal_child(True)  # Visible by default
        ...
        win.toolbars_wrapbox.set_child_spacing(4)
        win.toolbars_wrapbox.set_line_spacing(4)
        #win.toolbars_wrapbox.add_css_class("toolbar-container")
        ...
        # --- Edit operations group (Cut, Copy, Paste) ---
        edit_group = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=0)
        edit_group.add_css_class("linked")  # Apply linked styling
        edit_group.set_margin_start(0)
        ...
        # --- Column layout and case button group ---
        column_case_group = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=0)
        column_case_group.add_css_class("linked")  # Apply linked styling
        column_case_group.set_margin_start(0)
        ...
        # Add column/case group to toolbar
        win.toolbars_wrapbox.append(column_case_group)
        
        # Create paragraph, font family, font size box
        para_font_size_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=0)
        para_font_size_box.add_css_class("linked")
        ...
        # --- Basic formatting buttons (Bold, Italic, Underline, Strikeout) ---
        bius_group = Gtk.Box(css_classes=["linked"], orientation=Gtk.Orientation.HORIZONTAL, spacing=0)
        bius_group.set_margin_start(0)
        bius_group.set_margin_end(0)
        ...
        # --- Formatting marks and drop cap buttons ---
        dropcap_formatting_marks_group = Gtk.Box(css_classes=["linked"], orientation=Gtk.Orientation.HORIZONTAL, spacing=0)
        dropcap_formatting_marks_group.set_margin_start(0)
        dropcap_formatting_marks_group.set_margin_end(0)
        win.format_marks_button = Gtk.ToggleButton(icon_name="format-show-marks-symbolic")
        ...
        # --- Color buttons (Text and Background) ---
        color_bg_group = Gtk.Box(css_classes=["linked"], orientation=Gtk.Orientation.HORIZONTAL, spacing=0)        
        color_bg_group.set_margin_start(0)
        color_bg_group.set_margin_end(0)
        ...
        # --- Insert operations group (Table, Text Box, Image, Link) ---
        insert_group = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=0)
        insert_group.add_css_class("linked")  # Apply linked styling
        insert_group.set_margin_start(0)
        ...
        # Add toolbar revealer as an additional top bar in toolbar view
        win.toolbar_view.add_top_bar(win.toolbar_revealer)
        
        # Create content box (for webview and find bar)
        content_box = Gtk.Box(orientation=Gtk.Orientation.VERTICAL)
        content_box.set_vexpand(True)
        content_box.set_hexpand(True)
        ...
        # Set the content area of the toolbar view
        win.toolbar_view.set_content(content_box)
        
        # Create statusbar with margins
        statusbar_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=0)
        statusbar_box.set_margin_start(10)
        statusbar_box.set_margin_end(10)
        statusbar_box.set_margin_top(4)
        statusbar_box.set_margin_bottom(4)
        ...
        # Set the statusbar as the bottom bar of the toolbar view
        win.toolbar_view.add_bottom_bar(statusbar_box)
        
        # Set the toolbar view as the content of the window
        ...
        # Add to windows list and setup spacing actions
        self.windows.append(win)
        self.setup_spacing_actions(win)
...
/* CSS with visible custom border - Fixed for GTK4/libadwaita 1.7 */

/* Base styling for all entry fields (unfocused state) */
entry, 
searchentry,
searchentry text,
searchentry textview,
...
window.dark .replace-entry entry,
window.dark entry.replace-entry,
window.dark filechooser entry {
    background-color: #2d2d2d;
    color: #e0e0e0;
    caret-color: #e0e0e0;
}

/* Add visible custom focus border */
entry:focus,
combobox:focus,
combobox *:focus,
searchentry:focus,
...
searchentry textview:focus,
.search-entry entry:focus, 
entry.search-entry:focus,
.replace-entry entry:focus,
entry.replace-entry:focus,
...
/* Override default GTK focus style */
* {
    outline-style: none;
    outline-width: 0;
...
/* Override GTK's default selection color for text */
selection,
*:selected,
entry selection,
textview selection,
...
window.dark search-results,
window.dark .search-match {
...
/* Make sure focused entries have visible padding */
entry:focus,
searchentry:focus {
    padding: 4px 8px !important;
}

/* Ensure the border is drawn correctly - GTK4 compatible syntax */
entry:focus {
...
/* Explicitly add a visible border to focused entries with box-shadow as backup */
entry:focus {
    border: 1px solid rgba(127, 127, 127, 0.4) !important;
    box-shadow: 0 0 0 1px rgba(127, 127, 127, 0.4) !important;
}    
