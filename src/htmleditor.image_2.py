...
####################### Insert Image:
    def insert_image_js(self):
        ...
        return """
            ...
            function activateImageHandles(event) {
                ...
                // Setup drag functionality with fixed dragging issues
            ...
            // Improve alignment function to properly center images
            ...
            // Prevent default dragstart to avoid unwanted copying of images
            document.addEventListener('dragstart', function(e) {
                if (e.target.tagName === 'IMG' || e.target.classList.contains('img-wrapper') || 
    ...
    def insert_image_js(self):
        """JavaScript for insert image and related functionality"""
        # This method just returns the JS code - see the complete JavaScript in the other artifact
        # You'd replace this method with the implementation shown in the JavaScript artifact
        return """
            // Call code from the JavaScript artifact
            // See the full implementation in the Fixed Image JavaScript Functions artifact
        """
    ...
    def fix_javascript_image_code(self, win):
        ...
        // Also fix image resize handler to prevent duplicating images during drag
        document.addEventListener('dragstart', function(e) {
    ...
    def on_image_toolbar_registered(self, win):
        ...
        # Apply fixes for image dragging and JSON conversion
        # Call this after the WebView has loaded
        GLib.timeout_add(1000, lambda: self.fix_javascript_image_code(win))
        GLib.timeout_add(1000, lambda: self.update_align_image_function(win))
    ...
    def _show_image_properties_dialog(self, win, file_path=None, img_props=None):
        ...
        # Set initial state based on img_props
        if img_props and 'floating' in img_props:
            float_check.set_active(bool(img_props['floating']))
